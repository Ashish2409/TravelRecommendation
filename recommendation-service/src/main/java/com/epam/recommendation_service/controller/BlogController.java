...
public class BlogController {
    ...
    public ResponseEntity<?> addOrUpdateRating(@PathVariable Integer blogId,
    ...
    @GetMapping("/{blogId}/ratings/average")
    public ResponseEntity<Double> calculateAverageRating(@PathVariable Integer blogId) {
